...
export class Enemy extends Fighters {
  ...
  update(player) {
    ...
    if (billyLife === true) {
      ...
      if (
        (this.direction === "left" && distance >= 21) ||
