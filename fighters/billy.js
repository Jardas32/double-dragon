...
export class Billy extends Fighters {
  ...
  update(keys, womens, enemyLinda, enemyRoper, enemyWillams, bossAbobo) {
    ...
    if (this.y >= 391 && this.x >= 1576) {
      ...
      this.animations = [[292, 1010, 47, 45]];
    ...
    if (this.isFace === false && keys.lkick) {
      if (noMove === true) return;
      nofight = true;
      this.image.src = "img/Billy Lee.png";
      this.animations = [
    ...
    // Добавляеи жизни Billy
    if (this.lifeBilly < 100 && enemyWillams.isDead) {
      console.log("Enamys Deads");
      this.lifeBilly += 50;
    }
